...
namespace Core.CrossCuttingConcerns.Caching.Microsoft
{
    public class MemoryCacheManager : ICacheManager
    {
        ...
        {
            _memoryCache = ServiceTool.ServiceProvider.GetService<IMemoryCache>();// using Microsoft.Extensions.DependencyInjection; istiyor ampulle cozulmuyor manuel ekle
        }
        ...
        {
            return _memoryCache.TryGetValue(key, out _);//bize sadece anahtar varmı yokmu önemli
                                                        //yani sadece key gireceğiz
