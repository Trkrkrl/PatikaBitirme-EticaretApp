...
namespace Core.Aspects.Autofac.Caching
{
    public class CacheAspect : MethodInterception
    {
        ...
        public override void Intercept(IInvocation invocation)
        {
            ...
            var key = $"{methodName}({string.Join(",", arguments.Select(x => x?.ToString() ?? "<Null>"))})";//cachekey burada olusturulur
            ...
            invocation.Proceed();
            _cacheManager.Add(key, invocation.ReturnValue, _duration);//cachemanagere key i buradan gönderir
        }
        ...
        Cache eklenecek
        Anahtar,return value ve duration eklenmiş olacak
         * 
         */
    }
}
